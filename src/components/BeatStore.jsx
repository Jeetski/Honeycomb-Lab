  ...
  const reviews = [
    {
      ...
      link: { label: 'YouTube channel', url: 'https://www.youtube.com/@HIXXEL_SM' },
    },
    {
      name: 'Malkiq_Golqm',
      ...
      link: { label: 'YouTube channel', url: 'https://www.youtube.com/@VoininaHrista' },
    },
    {
      name: 'Dabuzy',
      avatar: '/Dabuzy.jpg',
    ...
    <main className="page">
      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .cmp-list{list-style:none;padding-left:0;margin:8px 0 0;color:var(--muted)}
        .cmp-list li{display:flex;gap:8px;align-items:flex-start;margin:6px 0}
...
/* CONTACT / MORE DROPDOWNS */
        ...
        /* SUBSCRIBE */
        .subscribe-wrap{display:grid;grid-template-columns:1fr 360px;gap:20px;align-items:center}
        @media (max-width:1024px){.subscribe-wrap{grid-template-columns:1fr}}
        .subscribe-left{text-align:center}
        .subscribe-left .kicker,.subscribe-left .headline{text-align:center}
        .subscribe-art{display:flex;align-items:center;justify-content:center}
        .subscribe-art img{max-width:100%;width:420px;height:auto;border-radius:16px;border:1px solid var(--line);background:#1e1e1e;margin-top:24px}
