          ...
          >
            ...
            >
              <div style={{ position: 'relative', marginBottom: '12px' }}>
                <img
                  src="/merch/tees/i%27m_not_a_rapper/white_front.png"
                  alt="I'M NOT A RAPPER. | Honeycomb Lab | White Premium Tee"
                  style={{ width: '100%', display: 'block', borderRadius: '8px', background: '#0f1012' }}
                  loading="lazy"
                />
              </div>
              <h3 style={{ margin: '0 0 6px', fontSize: '18px' }}>I'M NOT A RAPPER. — White Premium Tee</h3>
              <p className="subtle" style={{ margin: 0, color: 'var(--muted)' }}>€35–€46 (varies by size/region)</p>
            </article>
            ...
            >
              <div style={{ position: 'relative', marginBottom: '12px' }}>
                <img
                  src="/merch/tees/i%27m_not_a_rapper/black_front.png"
                  alt="I'M NOT A RAPPER. | Honeycomb Lab | Black Premium Tee"
                  style={{ width: '100%', display: 'block', borderRadius: '8px', background: '#0f1012' }}
                  loading="lazy"
                />
              </div>
              <h3 style={{ margin: '0 0 6px', fontSize: '18px' }}>I'M NOT A RAPPER. — Black Premium Tee</h3>
              <p className="subtle" style={{ margin: 0, color: 'var(--muted)' }}>€35–€46 (varies by size/region)</p>
            </article>
          </div>
        </div>
