          ...
          >
            ...
            >
              <div
                ...
                aria-hidden="true"
              />
              <h3 style={{ margin: '0 0 6px', fontSize: '18px' }}>Logo Tee</h3>
              <p className="subtle" style={{ margin: 0, color: 'var(--muted)' }}>Black • S–XL</p>
            </article>
            ...
            >
              <div
                ...
                aria-hidden="true"
              />
              <h3 style={{ margin: '0 0 6px', fontSize: '18px' }}>Embroidered Cap</h3>
              <p className="subtle" style={{ margin: 0, color: 'var(--muted)' }}>Black/Gold • OSFM</p>
            </article>
            ...
            >
              <div
                ...
                aria-hidden="true"
              />
              <h3 style={{ margin: '0 0 6px', fontSize: '18px' }}>Sticker Pack</h3>
              <p className="subtle" style={{ margin: 0, color: 'var(--muted)' }}>Set of 5</p>
            </article>
          </div>
        </div>
      </section>
